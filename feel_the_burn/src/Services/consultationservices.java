    ...
    //--------------------------------- nb Consult ---------------------------------------------------------//
     ...
     public  void Excel ()
     {
        try{
           ...
           XSSFSheet sheet= wb.createSheet("Details Consultation");
           XSSFRow header= sheet.createRow(0);
           header.createCell(0).setCellValue("Id_c");
           header.createCell(1).setCellValue("Nom");
           header.createCell(2).setCellValue("Age");
           header.createCell(3).setCellValue("Sexe");
           header.createCell(4).setCellValue("Date_rdv");
           header.createCell(5).setCellValue("Etat_physique");
           header.createCell(6).setCellValue("categorie_c");
           header.createCell(7).setCellValue("Prenom");
           header.createCell(8).setCellValue("Email");
           
           int index= 1;
           while(rs.next()){
               XSSFRow row = sheet.createRow(index);
               row.createCell(0).setCellValue(rs.getString("Id_c"));
               row.createCell(1).setCellValue(rs.getString("Nom"));
               row.createCell(2).setCellValue(String.valueOf(rs.getInt("Age")));
               row.createCell(3).setCellValue(rs.getString("Sexe"));
               row.createCell(4).setCellValue(rs.getString("Date_rdv"));
               row.createCell(5).setCellValue(rs.getString("Etat_physique"));
               row.createCell(6).setCellValue(rs.getString("categorie_c"));
               row.createCell(7).setCellValue(rs.getString("Prenom"));
               row.createCell(8).setCellValue(rs.getString("Email"));
               index++;
               
           }
            FileOutputStream fileout = new FileOutputStream("C:\\Users\\zeine\\Music\\feel_the_burn\\consultation.xlsx");
            wb.write(fileout);
            fileout.close();
